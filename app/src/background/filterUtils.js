  ...
  filterUnit(args) {
    ...
    switch (operator) {
      ...
      case '!=':
        ...
        break;
      case 'contain':
        return curVal.includes(target);
        break;
      case 'notContain':
        return !curVal.includes(target);
        break;
      case 'startsWith':
        return curVal.startsWith(target);
        break;
      case 'endsWith':
        return curVal.endsWith(target);
        break;
      case 'regexp':
        let regexp = new RegExp(target, 'ig')
        return curVal.match(regexp);
        break;
      case 'empty':
        console.log(curVal === undefined);
